...
canvas_height = 400
canvas_width = 800
win = Tk('EGG CATCHER GAME')
c = Canvas(win, width = canvas_width, height = canvas_height, background = 'light sky blue')
...
#For the egg
color_cycle = cycle(['red', 'blue', 'pink', 'blue', 'grey', 'cyan', 'yellow', 'purple', 'brown','white'])
egg_width = 45
egg_height = 55
egg_score = 10
egg_speed = 100
